...
function TenantRegistrationForm({ onSubmit, processing }) {
  ...
  const formRules = {
    businessName: { required: t('tenant.Business name is required') },
  ...
  return (
    <Form onSubmit={handleSubmit(onSubmit)}>
      ...
      <FormGroup>
        <Label>{t('tenant.Business Name')}</Label>
        <Controller
          name="businessName"
          control={control}
...
TenantRegistrationForm.propTypes = {
