...
function ManageClientUserForm({ onSubmit, processing, defaults: { active, tenantAdmin }, ownUser }) {
  const {
    handleSubmit,
    control,
    formState: { errors },
...
ManageClientUserForm.propTypes = {
...
export default ManageClientUserForm;
